        ...
        exporter.accept(NyakoLoot.DIAMOND_CRATE_LOOT_TABLE,
                LootTable.builder().pool(
                        LootPool.builder()
                                ...
                                .with(ItemEntry.builder(Items.BOOK).weight(16).apply(EnchantWithLevelsLootFunction.builder(ConstantLootNumberProvider.create(70.0f)).allowTreasureEnchantments()))
                                ...
                                .with(ItemEntry.builder(NyakoItems.EMERALD_COIN).weight(8).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0f, 3.0f))))
