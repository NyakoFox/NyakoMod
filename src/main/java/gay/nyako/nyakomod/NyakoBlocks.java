...
public class NyakoBlocks {
    ...
    public static final Block ECHO_HANGING_SIGN         = register("echo_hanging_sign",         new HangingSignBlock(FabricBlockSettings.create().mapColor(MapColor.DARK_AQUA).solid().instrument(Instrument.BASS).noCollision().strength(1.0f), NyakoWoodTypes.ECHO));
    public static final Block ECHO_WALL_HANGING_SIGN    = register("echo_wall_hanging_sign",    new WallHangingSignBlock(FabricBlockSettings.create().mapColor(MapColor.DARK_AQUA).solid().instrument(Instrument.BASS).noCollision().strength(1.0f).dropsLike(ECHO_HANGING_SIGN), NyakoWoodTypes.ECHO));
    ...
    public static final Block ECHO_SIGN                 = register("echo_sign",                 new SignBlock(FabricBlockSettings.create().mapColor(ECHO_PLANKS.getDefaultMapColor()).instrument(Instrument.BASS).solid().noCollision().strength(1.0f), NyakoWoodTypes.ECHO));
    public static final Block ECHO_WALL_SIGN            = register("echo_wall_sign",            new WallSignBlock(FabricBlockSettings.create().mapColor(ECHO_PLANKS.getDefaultMapColor()).instrument(Instrument.BASS).solid().noCollision().strength(1.0f).dropsLike(ECHO_SIGN), NyakoWoodTypes.ECHO));
