...
public class NyakoFoodComponents {
    ...
    public static final FoodComponent SPECULAR_FISH = new FoodComponent.Builder().hunger(2).saturationModifier(0.1f).build();
    public static final FoodComponent HEART_BERRY = new FoodComponent.Builder().hunger(0).saturationModifier(0.0f).alwaysEdible().build();
}
