...
public class NyakoItems {
    ...
    public static final Item ENDER_GEM                  = register("ender_gem",                 new Item(new FabricItemSettings().group(ItemGroup.MISC).rarity(Rarity.EPIC)));
    public static final Item ECHO_PEARL                 = register("echo_pearl",                new EchoPearlItem(new FabricItemSettings().group(ItemGroup.MISC).rarity(Rarity.EPIC).maxCount(16)));
