...
public class PetFollowOwnerGoal
        extends Goal {
    ...
    public PetFollowOwnerGoal(PetEntity tameable, double speed, float minDistance, float maxDistance, boolean leavesAllowed) {
    ...
    public void tick() {
        ...
        if (this.tameable.squaredDistanceTo(this.owner) >= 144.0 * 4) {
            this.tryTeleport();
        } else {
